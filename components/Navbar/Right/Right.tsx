...
function HeaderButton({ href, name, Icon }: IHeaderButton): JSX.Element {
  return (
    <a
      href={href}
      className="flex gap-1.5 items-center h-9 sm:h-8 text-slate-700 dark:text-slate-300 hover:text-black dark:hover:text-white active:translate-y-0.5 link-underline">
